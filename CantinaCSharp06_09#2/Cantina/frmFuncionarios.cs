...
namespace Cantina
{
    public partial class frmFuncionarios : Form
    {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            if (txtNome.Text.Equals("") || txtEmail.Text.Equals("") || mskCPF.Text.Equals("   .   .   -") || mskCep.Text.Equals("     -   ") || TxtEndereco.Text.Equals("") || txtNumero.Text.Equals("") || txtBairro.Text.Equals("") || txtCidade.Text.Equals("") || cbbEstado.Text.Equals("")) ;
